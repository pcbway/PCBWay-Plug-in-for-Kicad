...
**Note: We have updated plugin for Kicad10,you could also place assembly order directly now.But we need to get the component "Manufacture Part Number". Please confirm you run the "Update Board from Schematic".**
...
### Manual installation
You can also download the latest ZIP file from https://github.com/pcbway/PCBWay-Plug-in-for-Kicad/releases/download/v1.0.5/KiCadToPCBWay_v1.0.5.zip, then open the "Plugin and Content Manager" from the main window of KiCad and install the ZIP file via "Install from File".
